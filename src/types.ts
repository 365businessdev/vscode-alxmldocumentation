...
export enum ALXmlDocDiagnosticCode {
	DocumentationMissing = "DOC0001", // XML documentation is missing
	...
	ObjectDocumentationMissing = "DOC0101" // XML documentation for object is missing
}
...
export enum ALXmlDocDiagnosticMessage {
	DocumentationMissing = "XML documentation is missing",
